...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        // This code uses a directory named "com.xxxx.CarLess" in the
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CarLess", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("CarLess.sqlite")
        
        do {
            try coordinator?.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: url, options: nil)
        } catch let error as NSError {
            NSLog("An error occurred while adding a persistent store to the core data coordinator. The coordinator is being set to nil. Error = \(error)")
            coordinator = nil
        }
        ...
        if let moc = self.managedObjectContext {
            if moc.hasChanges {
                do {
                    ...
                    NSLog("An error occurred when saving the managed object context. Error = \(error)")
                }
            }
        }
    }
