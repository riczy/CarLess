...
class ReputationController: UIViewController {
    ...
    func constructView() {
        ...
        view.addConstraint(NSLayoutConstraint(item: repView, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.Equal, toItem: self.bottomLayoutGuide, attribute: NSLayoutAttribute.Bottom, multiplier: 1.0, constant: 0))
