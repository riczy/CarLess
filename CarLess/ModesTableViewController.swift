...
//  CarLess
//
//  Created by Whyceewhite on 7/2/15.
...
class ModesTableViewController: UITableViewController {
    ...
    private var modes: [ModeType] = [
        ModeType(imageFilename: "trans-bike", name: "Bicycle"),
        ModeType(imageFilename: "trans-walk", name: "Walk"),
        ModeType(imageFilename: "trans-rideshare", name: "Ride Share"),
        ModeType(imageFilename: "trans-transit", name: "Bus/Train")
    ]
